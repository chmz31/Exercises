...
public class ControladorMenu implements ActionListener {
    ...
    public void iniciarListener() {
        ...
        ventana.menuItemBuscar.addActionListener(this);
    }
    ...
    private void mostrarBuscarPanel() {
        PanelBuscar buscar = new PanelBuscar();
        ControladorPanelBuscar control = new ControladorPanelBuscar(buscar, daocole);
        
        ventana.setContentPane(buscar);
        ventana.validate();
    }
